...
A Celery-backed ingestion pipeline that fetches arXiv papers daily, persists metadata to SQLite, stores PDFs on local disk, and exposes an agent layer for querying the corpus.
